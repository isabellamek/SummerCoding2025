...
//note 3 press
	if(key === 'j'){
		...
		for (let i = 0; i < circleY3.length; i++) {
			if(circleY3[i] <= noteY+70 && circleY3[i] >= noteY - 70){
				
				score = score + 10
				circleY3.splice(i, 1)
			}
			if(circleY3[i] >= 0 && circleY3[i] <= noteY - 70){
				score = score -5
			}
			if(circleY3[i] >= noteY + 70){
				score = score -5
			}
		}
	}
...
//note 4 press
	if(key === 'k'){
		...
		for (let i = 0; i < circleY4.length; i++) {
			if(circleY4[i] <= noteY+70 && circleY4[i] >= noteY - 70){
				
				score = score + 10
				circleY4.splice(i, 1)
			}
			if(circleY4[i] >= 0 && circleY4[i] <= noteY - 70){
				score = score -5
			}
			if(circleY4[i] >= noteY + 70){
				score = score -5
			}
		}
	}
